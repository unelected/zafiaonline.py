...
class Client(WebClient):
    ...
    def sign_in(self, email: str = "", password: str = "", token: str = "", user_id: str = "") -> Union[ModelUser, bool]:
        """
        Sign in into user
    ...
    def get_rating(self, rating_type: RatingType = RatingType.AUTHORITY, rating_mode: RatingMode = RatingMode.ALL_TIME) -> dict:
        data: dict = {
    ...
    def create_room(self, selected_roles: Optional[List[Roles]] = None, title: str = "", max_players: int = 8,
    ...
    def remove_type(self, mafia_type: int) -> None:
        data: dict = {
            PacketDataKeys.TYPE: "agu",
            "rmt": mafia_type
        }
        self.send_server(data)
